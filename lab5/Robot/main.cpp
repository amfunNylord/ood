...
void TestMenuWithFunctionalCommandPattern()
{
	...
	menu.AddItem("begin_macro", "Create new macro command", bind(&CMenuFP::BeginMacro, &menu));
	menu.AddItem("end_macro", "Stop editing macro and save", bind(&CMenuFP::EndMacro, &menu));
